...
export const RESOURCES: Record<string, ResourceDef> = {
  ...
  booklets: {
    ...
    fields: [
      { column: 'name', key: 'name', type: 'string', required: true },
      { column: 'redemption_interval', key: 'redemptionInterval', type: 'int', default: 0 },
      { column: 'is_active', key: 'isActive', type: 'bool', default: 0 },
      { column: 'offers', key: 'offers', type: 'string', default: '' },
      { column: 'amount', key: 'amount', type: 'number', default: 0 },
    ],
  },
  campaigns: {
    table: 'campaigns',
    searchColumns: ['name', 'promocode', 'type'],
    fields: [
      { column: 'campaign_category', key: 'campaignCategory', type: 'string', default: 'offer' },
      { column: 'name', key: 'name', type: 'string', required: true },
      { column: 'description', key: 'description', type: 'string', default: '' },
      { column: 'promocode', key: 'promocode', type: 'string', default: '' },
      { column: 'type', key: 'type', type: 'string', default: 'BOGO' },
      { column: 'start_date', key: 'startDate', type: 'string', required: true },
      { column: 'end_date', key: 'endDate', type: 'string', required: true },
      { column: 'is_active', key: 'isActive', type: 'bool', default: 0 },
      { column: 'starting_from', key: 'startingFrom', type: 'string', default: '12:00 AM' },
      { column: 'ending_at', key: 'endingAt', type: 'string', default: '11:59 PM' },
      { column: 'applicable_days', key: 'applicableDays', type: 'string', default: 'Sun,Mon,Tue,Wed,Thu,Fri,Sat' },
      { column: 'redeem_limit', key: 'redeemLimit', type: 'int' },
      { column: 'customer_limit', key: 'customerLimit', type: 'int' },
      { column: 'reset_frequency', key: 'resetFrequency', type: 'string' },
      { column: 'reset_limit', key: 'resetLimit', type: 'int' },
      { column: 'conditions', key: 'conditions', type: 'string', default: '' },
      { column: 'category_limit', key: 'categoryLimit', type: 'string', default: '' },
      { column: 'item_limit', key: 'itemLimit', type: 'string', default: '' },
    ],
  },
  'offer-qrs': {
    table: 'offer_qrs',
    ...
    fields: [
      { column: 'name', key: 'name', type: 'string', required: true },
      { column: 'type', key: 'type', type: 'string', default: 'With Offer' },
      { column: 'offer', key: 'offer', type: 'string', default: '' },
      { column: 'thank_you_message', key: 'thankYouMessage', type: 'string', default: '' },
      { column: 'home_screen_message', key: 'homeScreenMessage', type: 'string', default: '' },
      { column: 'is_active', key: 'isActive', type: 'bool', default: 0 },
      { column: 'print_pos', key: 'printPos', type: 'bool', default: 0 },
      { column: 'print_online', key: 'printOnline', type: 'bool', default: 0 },
    ],
  },
  'bank-accounts': {
    table: 'bank_accounts',
